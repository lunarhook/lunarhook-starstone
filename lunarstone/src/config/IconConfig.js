...
class IconConfig extends React.Component {
  ...
  static lunarstone = (<FontAwesome name="moon-o" size={buttonsize} color={blue} />)
  static lunarstoneSel = (<MaterialCommunityIcons name="yin-yang" size={buttonsize} color={blue} />)
