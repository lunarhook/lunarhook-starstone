...
RouteConfig={
    ...
    //工具是优先解决需求的工具，尽量免费
    "kitPage":{"name":"探索","route":"kitPage","titlename":"探索工具","icon":IconConfig.IconKit},
        ...
        "UniversechangesPage":{"name":"周易测评","route":"UniversechangesPage","icon":IconConfig.IconUniversechanges},
            "CalendarPage":{"name":"乾坤","route":"CalendarPage","titlename":"星罗坊","icon":IconConfig.IconCalendar},
            "CalendarPageFake":{"name":"乾坤","route":"CalendarPage","titlename":"星罗坊","icon":IconConfig.IconCalendar},
                "lunarstoneNewPage":{"name":"乾坤问卦","route":"lunarstoneNewPage","icon":IconConfig.lunarstoneSel},
                "lunarstoneFullInfoPage":{"name":"卦象详解","route":"lunarstoneFullInfoPage","icon":IconConfig.lunarstoneSel},
                "lunarstoneHistoryPage":{"name":"问卦历史","route":"lunarstoneHistoryPage","icon":IconConfig.IconDetail},
                "EightrandomNewPage":{"name":"乾坤四柱","route":"EightrandomNewPage","icon":IconConfig.EightrandomSel},
                "EightrandomMainPage":{"name":"乾坤四柱","route":"EightrandomMainPage","icon":IconConfig.EightrandomSel},
                "NumberMainPage":{"name":"乾坤八星","route":"NumberMainPage","icon":IconConfig.numluckySel},
                "EightrandomHistoryPage":{"name":"四柱历史","route":"EightrandomHistoryPage","icon":IconConfig.IconDetail},
                "TrackStarPage":{"name":"玄空飞星","titlename":"玄空飞星","route":"TrackStarPage","icon":IconConfig.IconFlyStar},
                "MarryNewPage":{"name":"合卺问礼","titlename":"合卺问礼","route":"MarryNewPage","icon":IconConfig.IconOlson},
                ...
                "PartnershipNewPage":{"name":"合伙事业","titlename":"合卺问礼","route":"PartnershipNewPage","icon":IconConfig.IconPartnership},
                "PartnershipMainPage":{"name":"合伙结果","titlename":"合婚结果","route":"PartnershipMainPage","icon":IconConfig.IconPartnership},
        ...
        "SloganShare":{"name":"国风开屏语","titlename":"国风开屏语","route":"SloganShare","icon":IconConfig.IconSloganShare},
        "NamePage":{"name":"五行起名","titlename":"五行起名","route":"NamePage","icon":IconConfig.IconNamePage},
        ...
        "LunarCoursePage":{"name":"无邪","route":"LunarCoursePage","titlename":"思无邪","icon":IconConfig.IconZhiyin},
        "LunarCoursePageFake":{"name":"无邪","route":"LunarCoursePageFake","titlename":"思无邪","icon":IconConfig.IconZhiyin},
       ...
       "MBTI1Module":{"name":"家庭关系","titlename":"家庭关系","route":"CourseBookPage","icon":""},   
