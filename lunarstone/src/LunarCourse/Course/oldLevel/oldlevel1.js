...
oldlevel1Module[0] = {
    ...
    "content": [
        "中国应该好好学学训诂学",
        " ",
        "　　打个比方，做善事为什么叫行善，做坏事为什么叫作恶，",
        " ",
        "　　其实很好解释，行善往往都是对人而言的，行，本意是十字路口，延伸含义以后就是排列，次序，行动。《尔雅·释宫》：堂上谓之行，堂下谓之步。所以说行是带有公开性。那么组合起来就是有准备的公开行动，才可能是行善，它强调了意识和公开性，公开为了可以监督和检讨。",
        " ",
        "　　作就不一样了，甲骨文作字是下刀的意思，是有切割，开拓的意思，从人从乍，乍就是刀子的原本意思，特别有指代手的含义，那么组合起来就是动手用刀去做的事，刀是一种工具，作为利器还是比较凶险的，人手握凶器，通常就是做坏事的，比如作恶多端。所以说作恶。",
...
oldlevel1Module[1] = {
    ...
    "content": [
        "　　",
        "　　真正的道理，不论有没有人类都存在，人类要给这些道理起名字，实际上是没有这个资格的，所以，非常道，也非常名。名字是为了认识这些道理，没有认识以前，哪怕以前是有名字的，只要你还不知道就叫做无，你知道了就叫做有。这就是有和无，但是还有一些变化，不见得知道了就真的知道了。物质性的有和无很容易辨识，就是你思想认识到物质世界客观存在与否，但是如果说你是不是有善心，这个就很困难说明自己有没有了。因为善和恶的定义只有人类社会才有，这并不是真正的道。不能因为他善就有道德，不能因为他恶就没有道德。所以有无只是你的相似是否认识了问题，只判断认识与否，不能判断好坏这种人类社会的结果，认识的变化，也就是玄妙，会决定你的从无到有，也会决定你的从有到无，比如一个的人的善心，这是会变化的。所以一个人并不是有道德，而是在遵守或者不遵守道德而已。遵守了有德和不遵守无德，同出而异，会变化的，玄之又玄，不停的变化",
        " ",
        "　　我们建立规则肯定不是为了利益最大化，那么多少是考虑安全也就是控制。那么打破规则的原因应该就是不够安全或者为了利益，或者任性。人制定的规则人都是可以打破的，为了约束某些规则而有了法律，破坏规则就有了法律约束，一种公开的带有惩罚措施的规则。一般来说群体规则都带有法律约束，个体比较难打破，所以能打破的就是个体和个体之间，比如家庭内，而最高边界也就是离婚，即完全打破。",
        " ",
        "　　打破安全，目的可能就是自己的需求，合理的需求还是可以理解的，但是为了自己不合理的需求打破婚姻，这种就是任性无知，或者就是做恶了，最终引发的问题就是不够安全。所以打破规则的人，如果是不合理的规则，你可能是成功的，但是如果为了需求和利益，你自身一定是不安全的，等你意识到这一点的时候，基本都是积重难返的",
        "",
    ],
}
/*
...
module.exports = { oldlevel1Module: oldlevel1Module }