...
class IconConfig extends React.Component {
  ...
  static starstone = (<FontAwesome name="moon-o" size={buttonsize} color={blue} />)
  static starstoneSel = (<MaterialCommunityIcons name="yin-yang" size={buttonsize} color={blue} />)
