...
var fivelevel1Module = new Array()
fivelevel1Module[0] = {
    "index": "五行掌握·感受自然",
    "name": "课程开篇",
    "content": [
        "中国古代乃至世界人类的发展都是根据观察时间和世界变化，并建立关系得到的，比如我们所有的秋收冬藏，是根据时间变化和生活特点建立的一些标准，我们在最开始的环节里并不是直接讲述周易是如何的，而且先从理解周易是怎么由来的，为什么会这么由来，比如易字和卜字其实原本都是测量太阳的工具，易以结绳表示，卜则用刻木尺度表示，就是要把自然世界和时间变化建立一个比较客观的联系，去感受自然。",
...
fivelevel1Module[1] = {
    ...
    "content": [
        "五行认识（一）",
        "　　中国古老的认识将世界分成五种元素：木 火 土 金 水。如果按古农历对应时间，分别是春，夏，长夏，秋，冬。按照颜色可以分成，绿，红，黄，白，黑，可以用成语青红皂白来对应（皂表示黑色）。对应的还有很多匹配的知识，我们会在更高级的课程中再次讲解。",
        " ",
        "五行生克（二）",
        "　　木 火 土 金 水。按照顺序顺生，成环，燃木生火，火焚生土，土藏蕴金，金能生水，蓄水养木。意思是木头可以燃烧，所以可以生火。火燃烧完成变灰烬会转化成土。土经常漫长的变化作用可以生出金属（矿物），二金属因为凝结的效果，在表面可以生露珠水。而水是植物生态的必须，水能生木",
        " ",
        "五行生克（三）",
        "　　木 火 土 金 水。按间隔顺序，以此相克，木可以克土，因为植物生长的过程可以钻出土地，光秃秃的石头山都能生长出树木。而火可以克金的道理比较容易理解，高温可以让金属熔化成液态。土可以克水可以让河流改道。金可以克木，比如刀具可以砍断植物。水可以灭火，自然就是水可以克火",
        "",
        "　　小结：五行变化的规律能让人在探索思考问题中，快速的理解很多问题并从五行变化的知识中将过去的知识迁移过来（这很类似于机器学习的知识迁移），又比如为什么金属可以切割木头，木头能生火的抽象含义，这个判断抽象能力的运用会在后期经常使用",
    ],
}
fivelevel1Module[2] = {
    "index": "五行掌握·感受自然",
    ...
    "content": [
        "由五行对应天干地支",
        "",
        "　　古代用甲乙共同表示春，是因为认为万事万物都有阴阳两方面，那么在天干顺序中，阴阳是交 替出现的，比如甲是阳属性的木，那么乙就是阴数据的木，而后依次类推，丙为阳属性火，丁 为阴属性火等等",
        "",
        "   天干的出现主要是因为基础计数，而基础计数开始通过手指计算，因为手指有10个，所以定 义了10天干",
        "",
        "   十天干分别是：甲 乙 丙 丁 戊 己 庚 辛 壬 癸",
        "   十天干五行是：木 木 火 火 土 土 金 金 水 水",
        "   十天干阴阳是：阳 阴 阳 阴 阳 阴 阳 阴 阳 阴",
        "",
        "　　十天干是后续需要的几个基础要点，需要牢记，以及对应十天干的五行",
        "",
        "　　十天干还有比较复杂的类象知识，我们会在中高阶段的内容中讲解",
        "",
        "　　小结:十天干是中国十进制计数基础，十天干和五行也有匹配关系",
    ]
}
...
fivelevel1Module[3] = {
    ...
    "content": [
        ...
        "　　地支和五行关系及应用（一）",
        "",
        "　　上一节中我们天干对应的一年的春，夏，长夏，秋，冬季节，随着对地球季节的变化和细节的掌握，我们从一年的十月改变成十二个月，于是就有了地支记录。",
        "",
        "　　后来在记录方法中调整消除了长夏，并将长夏分成四份，分别放入其它的季节之末补足",
        "",
        "　　这样就形成了 春，寅、卯、补辰，夏、巳、午、补未，秋、申、酉、补戌，冬，亥、子、补丑",
        "",
        "　　地支和五行关系及应用（二）",
        "",
        "　　而丑未辰戌我们成为四隅，卯、午、酉、子我们称为四正，也就是以后的四桃花，可以见图",
        "",
        "　　所以地支也可以和方向结合，子表示北方，午表示南方，卯表示东方，酉表示西方",
        "",
        "　　地支和五行关系及应用（三）",
        "",
        "　　十二地支还有一些刑冲克害，对人的性格脾气有一些影响，而原本地支也带有五行特征，有生克含义，所以会导致部分刑冲克害存在一些复杂的情况，比如两者五行相同但是冲，所以就是合冲的含义，在一些六爻八字的具体分析中，衰旺分析中，还需要自己分析",
        "",
        "　　小结：十二地支将一年分成十二个月，每个月都表示一个五行。十二地支还可以辨识方位，每个方位也存在五行，部分方位还有自己的特点。",
    ]
}
fivelevel1Module[4] = {
    "index": "五行掌握·感受自然",
    ...
    "content": [
        "　　说文（一）",
        "",
        "　　文是先秦就有的，表示文，而文字则是汉初提出的，这样就把文和文字区别开。",
        "",
        "　　我们这里先说明文字，因为每个问题除了意思还包括五行（文字的五行，也就是字的五行可以在星罗坊的姓名五行查询中使用）",
        "",
        "　　所以在一些应用里，为了平衡五行，会用到其名学和五行的知识",
        "",
        "　　说文（二）",
        "",
        "　　既然提及文字，就需要了解文字的含义，这样就需要一些说文解字的知识，也就是解释字，这是训诂学和查字典的知识，我们会简单介绍一些",
        "",
        "　　比如英雄：草木精华为英，动物刚猛为熊",
        "",
        "　　比如祖宗：建功立业曰祖，守道有德曰宗",
        ...
        "　　说文（三）",
        "",
        "　　字在组成中有包边含义，所以用字的时候需要考究",
        "",
        "　　比如说月亮，可以用“月光”，也可以使用“月昱”因为昱就是表示光亮的意思",
        "",
        "　　这样的做法使用不改变含义而改变五行",
        "",
        "　　总结：古代对文和文字有不同的定义，我们可以使用一些有考究的字来改变某些物质的名而不改变物质的含义",
    ]
}
fivelevel1Module[5] = {
    "index": "五行掌握·感受自然",
    ...
    "content": [
        "　　解字（一）",
        "",
        "　　我们开始通过文字，引入一些周易的内容，比如易字，在解字中，实际上是一个杆子上有手节绳子的装置，用来测量太阳的装置，很类似于“卜”字，上面一个日字，慢慢的通过甲骨文的演化，形成了现在的易字，易字就是一种测量太阳的装置，这就是基本的解释文字的方式",
        "",
        "　　解字（二）",
        "",
        "　　我们有很多的文字还在用繁体字的时候，会明显的有文字的原始含义，比如“學習”的學字，学的繁体字上半部分是一个手把手的教户动作，内部是一个爻字，下半部分是个宝盖里面一个子，它的基本含义就是手把手的在房子里教你去探索感受问题",
        "",
        "　　在比如师傅的师字，以及帅字，都是有立干见影的含义，师是可以按规定测量太阳的人，表示出师。而帅字则是表示能掌握立杆的人，后来表示权利",
        "",
        "　　师也是周易的一卦，表示战争。所以卦除了卦象，还有名字的本意，需要结合的理解",
        "",
        "　　解字（三）",
        "",
        "　　庄子有解释过宇宙的含义：在《淮南子原道训》中有注：“四方上下曰宇，古往今来曰宙，以喻天地。",
        "",
        "　　庄子也解释过很多矛盾的本质：‘至大无外,谓之大一;至小无内,谓之小一’,《庄子·天下》，如何看待矛盾也可以运用一些五行生克，去寻找矛盾中主动的一方",
        "",
        "　　在比如老子的：大道废，有仁义，智慧出，有大伪。因为有假，才有真的逻辑含义。",
        "",
        "　　总结：对五行的理解以后，需要对文字五行和含义都有进一步的理解，才能更好的领悟周易所表达的含义，最初始的表象，比如卦名，就是对这件事的基本定位，找准问题的定位，也就是问题的观察角度非常重要，这是周易的第一个最基本原理。而在定位基础上发现矛盾，并观察矛盾的主要方面和次要方面，就是易经的第二功能，阐述矛盾。辨别矛盾是一个比较复杂的技术，又些矛盾在时空变换中还会彼此变化，以后易经的例子中我们会再讲解",
    ]
}
fivelevel1Module[6] = {
    "index": "五行掌握·感受自然",
    ...
    "content": [
        "　　卦（一）",
        "",
        "　　我们学习了五行以后，会发现古代人会用一种符号去表示某种五行，比如天，我们就用乾，它的具体描述是三个长横线",
        "",
        "　　我们学习了五行以后，会发现古代人会用一种符号去表示某种五行，比如天，我们就用乾，它的具体描述是三个长横线",
        "",
        "　　卦（二）",
        ...
        "　　卦（三）",
        "",
        "　　只有一行的叫阴阳，按长短分成两仪，由两个两仪组成了四象，也可以理解为地图上的四个方向，在增加一个两仪则形成八卦。",
        "",
        "　　小结：古代人用长短不一的横线表示阴阳，经过一系列的组合，排成八卦，并确定了名字和所属五行",
    ]
}
fivelevel1Module[7] = {
    "index": "五行掌握·感受自然",
    ...
    "content": [
        ...
        "　　卦（四）",
        "",
        "　　只有三行的觉把八经卦，六行的是八卦。上下重叠的八经卦会组成八卦。",
        "",
        "　　卦（五）",
        "",
        "　　䷀ ䷹ ䷝ ䷲ ䷸ ䷜ ䷸ ䷁",
        ...
        "　　卦（六）",
        "",
        "　　八经卦重叠以后，上下相通和上下不同的全部组合一共有六十四个，也就是六十四卦",
        "",
        "　　小结：三横长短不一的阴阳横线排成八经卦，八经卦的重叠组合组成六十四卦",
...
fivelevel1Module[8] = {
    ...
    "content": [
        "　　周易乾坤（一）",
        "",
        "　　周易乾坤是由八个宫卦（八个基本卦组成的），比如乾卦重叠以后䷀的样子，就是八卦，按照八八六十四的组合共计六十四卦，我们现在通常使用的六爻，就是基于此",
        "",
        "　　周易乾坤（二）",
        "",
        "　　周易六十四卦每一卦都有自己的名字，除了名字，每个卦都是爻词和篆词，每一横行表示一爻，六爻组成一个卦的结果",
        "",
        "　　周易乾坤（三）",
        "",
        "　　关于解卦有多种方式，目前因为难度，我们只给文王卦的解释方式和基本判断吉凶的方法，基于六亲纳甲判断问题的方式我们目前还不能直接讲解，它是易经六爻中的最高级内容",
        "",
        "　　周易乾坤（四）",
        "",
        "　　周易文王卦的解释方式通常基于两种，都比较固定，只能大致判断问题，比如师卦，表示战争，比如讼卦，表示打官司。此外还有一些可以基于上三爻和下三爻的五行去判断的方法，比如天泽履，下三爻是兑卦， 上三爻是乾卦，二个都是金，相对来说，还是比合的，并不存在生克，所以对事情的判断还是有惊无险的，本身也符合履卦的含义",
        "",
        "　　小结：周易乾坤是有两个经卦组成的八卦按照不同组合组合而成，每一卦都有名字，基于名字也有基本含义，可以很简单的判断吉凶",
        "",
...
fivelevel1Module[9] = {
    ...
    "content": [
        "　　八卦（一）",
        "",
        "　　乾 兑  离 震  巽  坎 艮 坤这是上节课学的内容，符号我们并不需要记录，以后有工具可以查询，但是我们需要先记录他们的五行属性，八经卦的基本属性需要记好",
        "",
        "　　乾（金）兑（金）离（火）震（木）巽（木）坎（水）艮（土） 坤（土）这里呢，除了水火以外，都有两个字，需要记好",
        "",
        "　　八卦（二）",
        "",
        "　　这些字还可以根据方位排布，按排布顺序分成先天八卦图和后天八卦图，见图。先天八卦和后天八卦的来源是根据河图洛书由来，因为内容比较复杂，不在本课程内涉及，大家可以去自由探索",
        "",
        "　　八卦（三）",
        "",
        "　　卦除了可以表示方向，可以表示五行，还有五行生克，基本来说八卦是一种时空组合知识",
        "",
        "　　小结：我们目前主要用后天八卦，需要了解八卦的五行和方位",
        "",
...
fivelevel1Module[10] = {
    ...
    "name": "十、八卦",
       "content": [
        "　　八卦（四）",
        "",
        "　　我们主要学习后天八卦的排布问题。北坎，南离，震东，兑西，巽东南，艮东北，坤西南，乾西北。后天八卦的位置和先天不同，需要记录好，这些方位后面会用到",
        "",
        "　　八卦（五）",
        "",
        "　　八卦是易经的最基本组成，为什么叫周易呢，因为在周文王时代形成，那之前是什么样子呢，传说是夏朝用连山易，商朝用归藏易，不过都失传了，也不会在本课程中涉及，大家可以自由探索这方面的历史。历史上说的三坟，就是说的连山，归藏，周易这三本，为什么要叫坟呢？因为最早的文字记录方法是刻在陶上，把文字刻在土做的器物上，所以叫坟，这里就运用到说文解字的知识了，以后类似的解释还会更多",
        "",
        "　　小结：我们目前了解八卦的五行和方位，此外还有一些历史知识需要了解，易经是古代的工具书",
...
fivelevel1Module[11] = {
    ...
    "content": [
        "　　八卦（五）",
        "",
        "　　为了比较简单的理解八卦，我们需要了解孔子的十翼，这是八卦解释比较入门的内容，我们先跳过十翼前面的爻词，象辞，彖词的部分，他们需要太多的语文知识",
        "",
        "　　八卦（六）",
        "",
        "　　我们比较推荐先了解序卦传和杂卦传，他们用比较简单的语言表示了卦的含义",
        "",
        "　　八卦（七）杂卦传",
        "",
        "乾刚，坤柔，比乐，师忧。",
...
fivelevel1Module[16] = {
    ...
    "content": [
        ...
        "　　一、八经卦，表示五行和方向",
        "",
        "　　二、八经卦相同重叠形成八宫卦，异重叠形成其他的五十六卦，共计六十四卦",
        "",
        "　　三、六十四卦以乾坤为首，讲述自然原理和社会原理",
        "",
    ]
}
fivelevel1Module[17] = {
    ...
    "content": [
        "　　本节课，我们总结下周易乾坤",
        "",
        "　　四、卦名，杂卦和序卦从整体解释了卦的基本含义",
        "",
        "　　五、通过乾坤文言，理解卦的每个爻都是连续变化的",
        "",
        "　　六、整体看卦，以重叠看卦，从每一爻看卦表示看到事物方式的不同，整体看卦，是对事物的整体抽象，很概括。重叠看卦，是在问题本身去看待事物或者关系的矛盾主要和次要方面。而顺序看每一爻，也就是八卦的每一行的解释是去观察连续变化的特点",
        "",
        "　　七、关于纳甲分析法相对复杂，我们暂时不讲解",
    ]
}
fivelevel1Module[18] = {
    "index": "五行掌握·感受自然",
    ...
    "content": [
        ...
        "　　一、首先是在谈判和观察角度",
        "",
        "　　比如你在一场会议中，判断你和对方在办公室的坐位上的位置，就可以知道谈判的关系，比如对方做北，你在南面，",
        "",
        "　　可以理解为水火既济，也可以理解成水火未济，这因为每个人的角度不同，需要判断谁强谁弱，把控问题",
        "",
        "　　二、以卦意理解事情的状态",
        "",
        "　　比如抽到《讼》《师》这样的卦，以及对待处理的方法，自己强还是对方强，如果主导问题",
        "",
        "　　三、对一些事情变化的理解",
        "",
        "　　比如抽到了《复》卦，《大壮》，《小过》等卦的处理办法",
        "",
        "　　四、对人物关系的理解",
        "",
        "　　比如抽到了《中浮》《恒》《渐》卦讲人际关系和环境的，在比如抽到了《天风姤》《山泽咸》这样讲感情的",
    ]
}
/*
fivelevel1Module[19] = {
...
module.exports = { fivelevel1Module: fivelevel1Module }